...
// free NBA Yungboy
        ...
        if(tagOfInterest==null || tagOfInterest.id==left){
            ...
            TrajectorySequence parking = drive.trajectorySequenceBuilder(new Pose2d())
                    .lineToLinearHeading(new Pose2d(-23.5,-10, Math.toRadians(30)))
                    .strafeLeft(32)
                    .forward(6)
...
//make seperate paths if needed.
            ...
            Trajectory left2 = drive.trajectoryBuilder(new Pose2d())
                    .lineToLinearHeading(new Pose2d(-8,5, Math.toRadians(106)))
                    .addTemporalMarker(.1, () -> {
                        ElevatorMotor.getCurrentPosition();
                        ElevatorMotor.setTargetPosition(320);
                        ElevatorMotor.setPower(.7);
            ...
            Trajectory park = drive.trajectoryBuilder(new Pose2d())
                    .lineToLinearHeading(new Pose2d(-8,2, Math.toRadians(35)))
...
//cone2
            ...
            Trajectory left2 = drive.trajectoryBuilder(new Pose2d())
                    .lineToLinearHeading(new Pose2d(-7,5, Math.toRadians(105)))
                    .addTemporalMarker(.1, () -> {
                        ElevatorMotor.getCurrentPosition();
                        ElevatorMotor.setTargetPosition(320);
                        ElevatorMotor.setPower(.7);
